...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Sistem Realisasi Retribusi Mobile & Web'); ?> - BAPENDA</title>
...
<body>
    ...
    <div class="offcanvas offcanvas-start bg-dark text-white" tabindex="-1" id="mobileSidebar" style="background: linear-gradient(180deg, #7f1d1d 0%, #991b1b 100%) !important;">
        ...
        <div class="offcanvas-body p-0 pt-3">
            ...
            <a href="<?php echo e(route('upload.index')); ?>" class="mobile-nav-link <?php echo e(request()->routeIs('upload.*') ? 'active' : ''); ?>">
                <i class="fas fa-file-upload me-2"></i> Upload PDF & Parsing
            </a>
            <a href="<?php echo e(route('realisasi.index')); ?>" class="mobile-nav-link <?php echo e(request()->routeIs('realisasi.*') ? 'active' : ''); ?>">
                <i class="fas fa-table me-2"></i> Data Realisasi
            </a>
            <?php if(Auth::check() && Auth::user()->isAdmin()): ?>
            <a href="<?php echo e(route('audit.index')); ?>" class="mobile-nav-link <?php echo e(request()->routeIs('audit.*') ? 'active' : ''); ?>">
                <i class="fas fa-history me-2"></i> Audit Trail Log
            </a>
            <?php endif; ?>
            <hr class="border-light border-opacity-25 mx-3">
            <form action="<?php echo e(route('logout')); ?>" method="POST" class="px-3">
                <?php echo csrf_field(); ?>
    ...
    <aside class="sidebar-desktop">
        ...
        <a href="<?php echo e(route('upload.index')); ?>" class="nav-link <?php echo e(request()->routeIs('upload.*') ? 'active' : ''); ?>">
            <i class="fas fa-file-upload"></i> Upload PDF & Parsing
        </a>
        <a href="<?php echo e(route('realisasi.index')); ?>" class="nav-link <?php echo e(request()->routeIs('realisasi.*') ? 'active' : ''); ?>">
            <i class="fas fa-table"></i> Data Realisasi
        </a>

        <?php if(Auth::check() && Auth::user()->isAdmin()): ?>
        <a href="<?php echo e(route('audit.index')); ?>" class="nav-link <?php echo e(request()->routeIs('audit.*') ? 'active' : ''); ?>">
            ...
            <div class="d-flex align-items-center justify-content-between mb-2">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div style="line-height:1.2; overflow:hidden;">
                        <span class="d-block text-white text-truncate small fw-bold"><?php echo e(Auth::user()->name ?? 'Pengguna'); ?></span>
                        <small class="text-white-50" style="font-size:0.7rem;"><?php echo e(Auth::user()->opd_name ?? 'OPD'); ?></small>
                    </div>
                </div>
            </div>
    ...
    <main class="main-wrapper">
        ...
        <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between pb-3 mb-4 border-bottom">
            <div>
                <h4 class="fw-bold mb-1" style="color: var(--dark-red);"><?php echo $__env->yieldContent('page_heading', 'Dashboard Overview'); ?></h4>
            ...
            <div class="d-flex align-items-center gap-2 mt-3 mt-md-0">
                <span class="badge bg-danger-subtle text-danger border border-danger-subtle px-3 py-2 rounded-pill fw-bold">
                    <i class="fas fa-shield-halved me-1"></i> Mode Akses: <?php echo e(Auth::user()->isAdmin() ? 'ADMINISTRATOR BAPENDA' : 'OPERATOR ' . strtoupper(Auth::user()->opd_name)); ?>
...
<?php /**PATH C:\Project\Projects\Ba\resources\views/layouts/app.blade.php ENDPATH**/ ?>