...
<head>
    ...
    <title>Cetak Laporan Realisasi Retribusi <?php echo e($tahun); ?></title>
...
<body>
    ...
    <div class="no-print d-flex justify-content-between align-items-center bg-light p-3 rounded mb-4 border">
        <a href="<?php echo e(route('realisasi.index')); ?>" class="btn btn-secondary btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
    ...
    <div class="text-center mb-4">
        ...
        <span class="small fw-bold">Tahun Anggaran <?php echo e($tahun); ?> <?php echo e($opd ? ' - ' . $opd : ''); ?></span>
    </div>
    ...
    <table class="table table-bordered align-middle">
        ...
        <tbody>
            <?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td class="text-center"><?php echo e($index + 1); ?></td>
                    <td class="fw-bold text-center"><?php echo e($row->kode_rekening); ?></td>
                    <td><?php echo e($row->nama_retribusi); ?></td>
                    <td><?php echo e($row->opd_name); ?></td>
                    <td class="text-center"><?php echo e($row->periode); ?></td>
                    <td class="text-end fw-bold">Rp <?php echo e(number_format($row->nilai, 0, ',', '.')); ?></td>
                </tr>
        ...
        <tfoot>
            <tr class="fw-bold table-light">
                ...
                <td class="text-end fs-6">Rp <?php echo e(number_format($totalNilai, 0, ',', '.')); ?></td>
            </tr>
        </tfoot>
    </table>
    ...
    <div class="row mt-5 pt-4">
        ...
        <div class="col-6 text-center">
            <p class="mb-5">Dicetak Tanggal: <?php echo e(date('d F Y')); ?><br><strong>Administrator Sistem Retribusi</strong></p>
            <p class="mt-5 pt-3 mb-0"><u>( <?php echo e($user->name ?? 'Admin BAPENDA'); ?> )</u><br>NIP. 19890211 201204 1 002</p>
        </div>
    </div>
...
<?php /**PATH C:\Users\agung windu\.gemini\antigravity\scratch\sistem-retribusi-github\resources\views/realisasi/print.blade.php ENDPATH**/ ?>