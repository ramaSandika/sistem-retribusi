        ...
        <div class="p-4 p-md-5">
            ...
            <form action="<?php echo e(route('register')); ?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control bg-light" placeholder="Nama Lengkap" value="<?php echo e(old('name')); ?>" required>
                </div>

                <div class="mb-3">
                    <label class="form-label fw-semibold small text-muted">Email Resmi</label>
                    <input type="email" name="email" class="form-control bg-light" placeholder="operator@retribusi.go.id" value="<?php echo e(old('email')); ?>" required>
                </div>
            ...
            <div class="border-top pt-3 text-center">
                ...
                <a href="<?php echo e(route('login')); ?>" class="small fw-bold text-danger ms-1 text-decoration-none">Login ke Sistem</a>
            </div>
...
<?php /**PATH C:\Users\agung windu\.gemini\antigravity\scratch\sistem-retribusi-github\resources\views/auth/register.blade.php ENDPATH**/ ?>