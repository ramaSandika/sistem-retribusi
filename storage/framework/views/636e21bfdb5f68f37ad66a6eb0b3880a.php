    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .bg-photo {
            position: fixed;
            inset: 0;
            background: url('<?php echo e(asset("kantor_bupati.jpg")); ?>') center center / cover no-repeat;
            z-index: 0;
        }
    ...
    <div class="page-wrapper">
        ...
        <div class="glass-card">
            ...
            <div class="register-link">
                ...
                <a href="<?php echo e(route('register')); ?>">Daftar Akun Operator</a>
            </div>
        </div>

        <!-- Footer kecil -->
        <p class="text-center mt-4" style="color:rgba(255,255,255,0.35); font-size:0.75rem;">
            &copy; <?php echo e(date('Y')); ?> BAPENDA Kabupaten Badung. Hak cipta dilindungi.
        </p>
    </div>

</body>
</html>
<?php /**PATH C:\Users\agung windu\.gemini\antigravity\scratch\sistem-retribusi-github\resources\views/auth/login.blade.php ENDPATH**/ ?>