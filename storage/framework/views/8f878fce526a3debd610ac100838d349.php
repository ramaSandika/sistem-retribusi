...
<head>
    ...
    <style>
        ...
        .login-banner {
            background: url('<?php echo e(asset("bapenda_gedung.jpg")); ?>') center center / cover no-repeat;
            position: relative;
            min-height: 480px;
            display: flex;
        ...
        <div class="row g-0">
            ...
            <div class="col-lg-6 col-12 p-4 p-md-5 d-flex flex-column justify-content-center">
                ...
                <div class="d-lg-none text-center mb-4 pb-3 border-bottom">
                    <img src="<?php echo e(asset('bapenda_gedung.jpg')); ?>" alt="Kantor BAPENDA" class="img-fluid rounded-4 mb-3 shadow-sm" style="max-height: 160px; width: 100%; object-fit: cover;">
                ...
                <?php if(session('info')): ?>
                    <div class="alert alert-info rounded-3 small py-2">
                        <i class="fas fa-info-circle me-1"></i> <?php echo e(session('info')); ?>
                ...
                <form action="<?php echo e(route('login')); ?>" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" name="email" class="form-control bg-light border-start-0" placeholder="admin@retribusi.go.id" value="<?php echo e(old('email')); ?>" autofocus>
                        </div>
                    </div>
                    <div class="mb-4">
                ...
                <div class="border-top pt-3 text-center">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="small fw-bold text-danger ms-1 text-decoration-none">Daftar Akun Operator</a>
                </div>
...
<?php /**PATH C:\Project\Projects\Ba\resources\views/auth/login.blade.php ENDPATH**/ ?>