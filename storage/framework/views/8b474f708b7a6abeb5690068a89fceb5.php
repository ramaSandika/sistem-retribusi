<?php $__env->startSection('title', 'Preview & Validasi Parsing PDF'); ?>
<?php $__env->startSection('page_heading', 'Preview Data & Validasi OCR PDF'); ?>
...
<div class="card-custom p-4 mb-4 border-danger border-2" style="border-style: dashed !important;">
    <div class="d-flex align-items-center justify-content-between mb-3 pb-3 border-bottom">
        <div>
            <h6 class="fw-bold text-danger mb-1">
                <i class="fas fa-clipboard-check me-2"></i> Hasil Pembacaan Parser PDF: <?php echo e($upload->original_filename); ?>

            </h6>
            <small class="text-muted">Instansi: <strong><?php echo e($opd_name); ?></strong> | Periode: <strong><?php echo e($periode); ?> <?php echo e($tahun); ?></strong></small>
        </div>
    ...
    <form action="<?php echo e(route('upload.save')); ?>" method="POST" id="validationForm">
        <?php echo csrf_field(); ?>
        ...
        <div class="table-responsive mb-4">
            <table class="table table-bordered align-middle" id="previewTable">
                ...
                <tbody id="tableBody">
                    <?php $__currentLoopData = $parsedItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="text-center fw-bold text-muted index-col"><?php echo e($index + 1); ?></td>
                            <td>
                                <input type="text" name="kode_rekening[]" class="form-control form-control-sm rounded-3 fw-bold" value="<?php echo e($item['kode']); ?>" required>
                            </td>
                            <td>
                                <input type="text" name="nama_retribusi[]" class="form-control form-control-sm rounded-3" value="<?php echo e($item['nama']); ?>" required>
                            </td>
                            <td>
                                <input type="number" name="nilai[]" class="form-control form-control-sm rounded-3 fw-bold text-success value-input" value="<?php echo e($item['nilai']); ?>" oninput="updateTotal()" required>
                            </td>
                ...
                <tfoot class="table-light">
                    <tr>
                        ...
                        <td class="fw-bold text-danger fs-6" id="grandTotal">Rp <?php echo e(number_format(array_sum(array_column($parsedItems, 'nilai')), 0, ',', '.')); ?></td>
                        <td></td>
                    </tr>
                </tfoot>
            </table>
        ...
        <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center gap-2">
            ...
            <div class="d-flex gap-2">
                <a href="<?php echo e(route('upload.index')); ?>" class="btn btn-light border fw-semibold">Batalkan</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Project\Projects\Ba\resources\views/upload/preview.blade.php ENDPATH**/ ?>